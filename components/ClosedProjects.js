...
import { GET_ALL_CLOSED_PROJECTS } from '../testApi/queries/getAllClosedProjects'
import { useQuery } from '@apollo/client'
import EventTile from './EventTile'
import CircularProgress from '@material-ui/core/CircularProgress'

const ClosedProjects = () => {
  const { loading, error, data } = useQuery(GET_ALL_CLOSED_PROJECTS)
  if (loading) {
    return (
  ...
  const unsorteredProjectList = data.getAllClosedProjects.data || []
